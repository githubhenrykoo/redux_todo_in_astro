...
+  const [workspace, setWorkspace] = useState(null);
   ...
   useEffect(() => {
     checkConnection();
@@ -41,20 +42,36 @@ const NotionPanel = ({ className = '' }) => {
...
@@ -240,43 +257,139 @@ const NotionPanel = ({ className = '' }) => {
...
@@ -383,6 +496,14 @@ const NotionPanel = ({ className = '' }) => {
           border-radius: 8px;
...
+        }
         ...
         .document-item {
           margin-bottom: 24px;
@@ -390,32 +511,20 @@ const NotionPanel = ({ className = '' }) => {
           border-radius: 8px;
         }
