...
export const JPGViewer = ({ content, contentType }) => {
  ...
  useEffect(() => {
    const processContent = () => {
      try {
        console.log("JPGViewer processing content:", typeof content, content instanceof Uint8Array);
        ...
        if (typeof content === 'object' && content !== null && 
          ...
          try {
            console.log("JPGViewer: Detected Node.js Buffer JSON format as object", content.data.length);
            ...
            setError("Unable to display JPEG: Error processing Buffer data");
            return;
          }
        }
        ...
        if (typeof content === 'string' && content.includes('"type":"Buffer"') && content.includes('"data":[')) {
          try {
            console.log("JPGViewer: Detected Node.js Buffer JSON format as string");
        ...
        if (typeof content === 'object' && Array.isArray(content)) {
          try {
            ...
            setError("Unable to display JPEG: Error processing array data");
            return;
          }
        }
        ...
        console.error("JPGViewer processing error:", err);
        ...
        setError(`Unable to display JPEG: ${err.message || 'Unknown error'}`);
      }
    };
    ...
    return (
      <div className="flex flex-col h-full p-4 bg-gray-50 overflow-auto">
        <div className="text-amber-600 text-center mb-4">
          ...
          <p className="font-medium">Content has image/jpeg type but appears to be text</p>
    ...
    <div className="flex flex-col items-center justify-center h-full p-4 bg-gray-50 overflow-hidden">
      ...
      <div className="relative max-w-full max-h-full overflow-auto">
        <img
          ...
          onError={(e) => {
            console.error("JPEG load error:", e);
            setIsLoading(false);
            setError("Failed to load JPEG: Image data may be corrupted");
          }}
        />
      </div>
