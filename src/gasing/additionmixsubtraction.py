...
def benchmark_subtraction(iterations: int = 100, verbose: bool = False) -> None:
    ...
    # Pre-generated test cases to avoid regenerating each time
    test_cases = [
        # Small numbers
        ("12345", "54321"),
        # Medium numbers (100 digits)
        ("9" * 100, "1" * 100),
...
def main() -> None:
    ...
    try:
        # Load a random subtraction problem from the dataset
        dataset_path = "src/gasing/addition/extended_subtraction_dataset.csv"
